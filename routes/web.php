...
Route::group(['middleware' => ['web', 'auth', 'userAkses:administrator,kades,umum,keuangan,kependudukan']], function () {
...
Route::group(['middleware' => ['web', 'auth', 'userAkses:administrator,umum']], function () {
...
Route::group(['middleware' => ['web', 'auth', 'userAkses:kades,administrator,umum']], function () {
...
Route::group(['middleware' => ['web', 'auth', 'userAkses:administrator,kependudukan']], function () {
    ...
    Route::get('/penduduk/cetak_pdf', 'PendudukController@cetakPenduduk')->name('cetak-penduduk');
    ...
    Route::get('/exportpelaporan', 'PelaporanController@export');

    Route::get('/pelaporan', [PelaporanController::class, 'cetakpenduduk'])->name('cetakpenduduk')->middleware('auth');
});

Route::group(['middleware' => ['web', 'auth', 'userAkses:administrator,keuangan']], function () {
