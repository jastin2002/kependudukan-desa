                ...
                <form autocomplete="off" action="{{ route('penduduk.update', $penduduk) }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('nik_ayah') is-invalid @enderror" name="nik_ayah" placeholder="Masukkan NIK Ayah ..." value="{{ old('nik_ayah', $penduduk->nik_ayah) }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('nik_ibu') is-invalid @enderror" name="nik_ibu" placeholder="Masukkan NIK Ibu ..." value="{{ old('nik_ibu', $penduduk->nik_ibu) }}">
