<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(1) == 'maillist' || Request::segment(1) == 'maillist') active @endif" href="{{ route('surat-disposisi.index') }}">
                    <i class="ni ni-single-copy-04 text-danger"></i>
                    <span class="nav-link-inner--text">Kelola Disposisi Surat</span>
                </a>
            </li>
            <li class="nav-item">
        ...
        <!-- Kependudukan -->    
            @if (auth()->user()->role=="kependudukan")         
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(1) == 'penduduk' || Request::segment(1) == 'tambah-penduduk') active @endif" href="{{ route('penduduk.index') }}">
                    <i class="fas fa-users text-info"></i>
                    <span class="nav-link-inner--text">Kelola Penduduk</span>
